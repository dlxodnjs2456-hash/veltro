(()=>{
  ...
  .wts-tv-head strong{font-size:13px;color:#111827;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:65%}.wts-tv-head span{font-size:12px;color:#6b7280}.wts-tv-head .live{margin-left:auto;color:#0c9b6a;font-weight:800;white-space:nowrap}
